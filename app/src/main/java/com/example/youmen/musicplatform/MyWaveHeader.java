...
public class MyWaveHeader {
     ...
     */
    public MyWaveHeader setFormat(short format) {
        mFormat = format;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public MyWaveHeader setNumChannels(short numChannels) {
        mNumChannels = numChannels;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public MyWaveHeader setSampleRate(int sampleRate) {
        mSampleRate = sampleRate;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public MyWaveHeader setBitsPerSample(short bitsPerSample) {
        mBitsPerSample = bitsPerSample;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public MyWaveHeader setNumBytes(int numBytes) {
        mNumBytes = numBytes;
        return this;
    }
