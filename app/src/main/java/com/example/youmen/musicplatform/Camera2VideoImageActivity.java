...
public class Camera2VideoImageActivity extends AppCompatActivity {
    ...
    private String fileStringUrl,selectedFileName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        musicname=(TextView)findViewById(R.id.vplayname) ;
    ...
    private void createVideoFolder() {
        ...
        mVideoFolder = new File(sdFile, "Video");
    ...
    public void playmusic(){
        ...
        mediaplayer.reset();
        try {
            mediaplayer.setDataSource(fileStringUrl); //播放錄音路徑
        } catch (IOException e) {
            e.printStackTrace();
        }
        try {
